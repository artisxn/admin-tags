...
use codicastudio\TagsField\TagsFieldServiceProvider;
...
abstract class TestCase extends Orchestra
{
    ...
    {
        return [
            \codicastudio\Tags\TagsServiceProvider::class,
    ...
    protected function setUpDatabase($app)
    {
        ...
        include_once __DIR__.'/../vendor/codicastudio/laravel-tags/database/migrations/create_tag_tables.php.stub';
